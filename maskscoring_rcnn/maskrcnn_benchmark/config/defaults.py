...
_C.INPUT.MAX_SIZE_TRAIN = 768  #（1333）
...
# 经RPN每张图产生的样本
_C.MODEL.RPN.BATCH_SIZE_PER_IMAGE = 2000
# Target fraction of foreground (positive) examples per RPN minibatch
_C.MODEL.RPN.POSITIVE_FRACTION = 0.5
# Number of top scoring RPN proposals to keep before applying NMS
# When FPN is used, this is *per FPN level* (not total)
_C.MODEL.RPN.PRE_NMS_TOP_N_TRAIN = 2000
_C.MODEL.RPN.PRE_NMS_TOP_N_TEST = 2000
# Number of top scoring RPN proposals to keep after applying NMS
_C.MODEL.RPN.POST_NMS_TOP_N_TRAIN = 2000
_C.MODEL.RPN.POST_NMS_TOP_N_TEST = 2000
...
# 每张图产生256，256*2*1
_C.MODEL.ROI_HEADS.BATCH_SIZE_PER_IMAGE = 16000
# Target fraction of RoI minibatch that is labeled foreground (i.e. class > 0)
_C.MODEL.ROI_HEADS.POSITIVE_FRACTION = 0.02
...
_C.MODEL.ROI_HEADS.DETECTIONS_PER_IMG = 40
