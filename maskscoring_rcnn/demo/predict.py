...
from predictor_1 import COCODemo
...
cfg.merge_from_list(["MODEL.MASK_ON", False]) # 打开mask开关
...
if __name__ == '__main__':
    ...
    in_folder = '/content/drive/MyDrive/maskscoring_rcnn/inference_input/sub_ships_train2018/paraller_ship/'
    out_folder = '/content/drive/MyDrive/maskscoring_rcnn/inference_output/parallel/'
